...
//    console.log(password)
  ...
  async function  callApi() {
   const response = await fetch('https://book-store-spring-boot.azurewebsites.net/api/login', {
  method: 'POST',
  headers: {
      ...
      <StatusBar barStyle={'dark-content'} translucent/>
        ...
        alignItems : 'center',}}  >
              ...
              <TouchableHighlight style={styles.touchableHighlight}
                >
                <Text style={[styles.loginBoutton, {color : visibleLoading ?colors.primary:  colors.white}]} onPress={login}>Login</Text>

                </TouchableHighlight>

                <View  style={{ justifyContent: "center", display : visibleLoading ? "flex": "none",  bottom:10, alignItems: "center"}}>
            ...
            <View style={styles.containerGoToSinup}>
                <Text style = {styles.textGoToSinup} >Don't have an account? <Text onPress={()=>  navigation.navigate('Register')} style={{color : colors.primary}} >Register!</Text> </Text> 
            ...
            <Modal
                ...
                <View style={styles.centeredView}     >
                  ...
                  <Text onPress={()=> setVisible(false) } style={styles.closeBtn}>✕</Text>
                    <Text style={styles.modalText}>Oops !</Text>

                    <Text style={styles.textStyle}>username or password is incorrect</Text>
